...
public class UserStoryDataTest {
    ...
    //Test2: Adding below test cases: 1. testGetNotes and testSetNotes
    @Test
    ...
    public void testSetNotes() {
        UserStoryData userStoryData = new UserStoryData();
        userStoryData.setName("newnotes");
        Assert.assertEquals("newnotes", userStoryData.getName());
    }
